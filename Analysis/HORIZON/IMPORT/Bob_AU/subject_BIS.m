classdef subject_BIS < handle
    ...
    methods
        ...
        function obj = subject_BIS(datadir, dataname)
            
            obj.dataname = dataname;
            obj.dataname_BIS = [dataname(1:end-4) '_BIS.mat'];
            obj.dataname_TPQ = [dataname(1:end-4) '_TPQ.mat'];
            obj.datadir = datadir;
        ...
        function scoreBIS(obj)
            ...
            fname = [obj.datadir obj.dataname_BIS];
            if exist(fname) == 2
                load(fname);
                Y = scoreBIS_one(userAnswers);
                obj.BIS_scores = Y;
                obj.BIS_answers = userAnswers';
            else
                obj.BIS_scores = nan(9,1);
                obj.BIS_answers = nan(30,1);
            end
        ...
        function scoreTPQ(obj)
            ...
            fname = [obj.datadir obj.dataname_TPQ];
            if exist(fname) == 2
                load(fname);
                [Y, names, RT] = TPQScoreSubject(answers);
                obj.TPQ_answers = [answers.keyNum]';
                obj.TPQ_RT = RT';
                obj.TPQ_scores = Y;
            else
                obj.TPQ_scores = nan(15,1);
                obj.TPQ_answers = nan(100,1);
                obj.TPQ_RT = nan(100,1);
