classdef analysis_bayesian < Siyuhandle
    ...
    methods
        function obj = analysis_bayesian(filename)
            ...
            dd = load(fullfile(obj.siyupathdatabayes, [filename '.mat']));
            obj.poolobj = [];
            ...
            switch obj.modelname
                case 'learningmodel'
                    obj.params = {'a0_p','b0_p','a_inf_p','b_inf_p',...
                        'mu0_mean_n','mu0_sigma_p','hyperIB_mean_ncond','hyperIB_sigma_pcond',...
                        'hyperN_k_pcond','hyperN_lambda_pcond','hyperN_mean','hyperSB_mean_ncond','hyperSB_sigma_pcond',...
